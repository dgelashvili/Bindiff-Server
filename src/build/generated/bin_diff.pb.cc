...
inline constexpr FunctionInfo::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        name_(
            &::google::protobuf::internal::fixed_address_empty_string,
...
template <typename>
PROTOBUF_CONSTEXPR FunctionInfo::FunctionInfo(::_pbi::ConstantInitialized)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(FunctionInfo_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
struct FunctionInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR FunctionInfoDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
  ~FunctionInfoDefaultTypeInternal() {}
  union {
    FunctionInfo _instance;
  };
};

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FunctionInfoDefaultTypeInternal _FunctionInfo_default_instance_;
...
const ::uint32_t
    TableStruct_bin_5fdiff_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::bin_diff::DiffReply, _impl_.unmatched_primary_),
        PROTOBUF_FIELD_OFFSET(::bin_diff::DiffReply, _impl_.unmatched_secondary_),
        ...
        0,
        PROTOBUF_FIELD_OFFSET(::bin_diff::FunctionInfo, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::bin_diff::FunctionInfo, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::bin_diff::FunctionInfo, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::bin_diff::FunctionInfo, _impl_.address_),
        0,
        1,
        ~0u,  // no _has_bits_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::bin_diff::GetReply, _impl_.functions_),
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {32, 46, -1, sizeof(::bin_diff::FunctionMatch)},
        {52, -1, -1, sizeof(::bin_diff::DiffReply)},
        {63, 72, -1, sizeof(::bin_diff::GetRequest)},
        {73, 83, -1, sizeof(::bin_diff::FunctionInfo)},
        {85, -1, -1, sizeof(::bin_diff::GetReply)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    ...
    &::bin_diff::_FunctionInfo_default_instance_._instance,
...
const char descriptor_table_protodef_bin_5fdiff_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "id_2\030\002 \001(\t\"\231\001\n\rFunctionMatch\022\027\n\017address_"
    "primary\030\001 \001(\004\022\031\n\021address_secondary\030\002 \001(\004"
    "\022\024\n\014name_primary\030\003 \001(\t\022\026\n\016name_secondary"
    "\030\004 \001(\t\022\022\n\nsimilarity\030\005 \001(\002\022\022\n\nconfidence"
    "\030\006 \001(\002\"\235\001\n\tDiffReply\022(\n\007matches\030\001 \003(\0132\027."
    "bin_diff.FunctionMatch\0221\n\021unmatched_prim"
    "ary\030\002 \003(\0132\026.bin_diff.FunctionInfo\0223\n\023unm"
    "atched_secondary\030\003 \003(\0132\026.bin_diff.Functi"
    "onInfo\"\030\n\nGetRequest\022\n\n\002id\030\001 \001(\t\"-\n\014Func"
    "tionInfo\022\014\n\004name\030\001 \001(\t\022\017\n\007address\030\002 \001(\004\""
    "5\n\010GetReply\022)\n\tfunctions\030\001 \003(\0132\026.bin_dif"
    "f.FunctionInfo2\256\001\n\rBinDiffServer\0228\n\006Uplo"
    "ad\022\027.bin_diff.UploadRequest\032\025.bin_diff.U"
    "ploadReply\0222\n\004Diff\022\025.bin_diff.DiffReques"
    "t\032\023.bin_diff.DiffReply\022/\n\003Get\022\024.bin_diff"
    ".GetRequest\032\022.bin_diff.GetReplyb\006proto3"
};
...
FunctionMatch::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(FunctionMatch, _impl_.address_primary_), 2>(),
     {8, 2, 0, PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.address_primary_)}},
    // uint64 address_secondary = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(FunctionMatch, _impl_.address_secondary_), 3>(),
     {16, 3, 0, PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.address_secondary_)}},
    // string name_primary = 3;
    {::_pbi::TcParser::FastUS1,
     {26, 0, 0, PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.name_primary_)}},
    // string name_secondary = 4;
    {::_pbi::TcParser::FastUS1,
     {34, 1, 0, PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.name_secondary_)}},
    // float similarity = 5;
    {::_pbi::TcParser::FastF32S1,
     {45, 4, 0, PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.similarity_)}},
    // float confidence = 6;
    {::_pbi::TcParser::FastF32S1,
     {53, 5, 0, PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.confidence_)}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
  }}, {{
    // uint64 address_primary = 1;
    {PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.address_primary_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
    // uint64 address_secondary = 2;
    {PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.address_secondary_), _Internal::kHasBitsOffset + 3, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
    // string name_primary = 3;
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // float similarity = 5;
    {PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.similarity_), _Internal::kHasBitsOffset + 4, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kFloat)},
    // float confidence = 6;
    {PROTOBUF_FIELD_OFFSET(FunctionMatch, _impl_.confidence_), _Internal::kHasBitsOffset + 5, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kFloat)},
  }},
  // no aux_entries
  {{
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000010u) != 0) {
    if (::absl::bit_cast<::uint32_t>(this_._internal_similarity()) != 0) {
      ...
      target = ::_pbi::WireFormatLite::WriteFloatToArray(
          5, this_._internal_similarity(), target);
    }
  }
...
PROTOBUF_NDEBUG_INLINE DiffReply::Impl_::Impl_(
    ...
    const ::bin_diff::DiffReply& from_msg)
      : matches_{visibility, arena, from.matches_},
        unmatched_primary_{visibility, arena, from.unmatched_primary_},
        unmatched_secondary_{visibility, arena, from.unmatched_secondary_},
        _cached_size_{0} {}
...
PROTOBUF_NDEBUG_INLINE DiffReply::Impl_::Impl_(
    ...
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
      : matches_{visibility, arena},
        unmatched_primary_{visibility, arena},
        unmatched_secondary_{visibility, arena},
        _cached_size_{0} {}
...
constexpr auto DiffReply::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      ...
      PROTOBUF_FIELD_OFFSET(DiffReply, _impl_.unmatched_primary_) +
          decltype(DiffReply::_impl_.unmatched_primary_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
      PROTOBUF_FIELD_OFFSET(DiffReply, _impl_.unmatched_secondary_) +
          decltype(DiffReply::_impl_.unmatched_secondary_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
...
DiffReply::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastMtR1,
     {18, 63, 1, PROTOBUF_FIELD_OFFSET(DiffReply, _impl_.unmatched_primary_)}},
    // repeated .bin_diff.FunctionInfo unmatched_secondary = 3;
    {::_pbi::TcParser::FastMtR1,
     {26, 63, 2, PROTOBUF_FIELD_OFFSET(DiffReply, _impl_.unmatched_secondary_)}},
  }}, {{
    65535, 65535
  }}, {{
    // repeated .bin_diff.FunctionMatch matches = 1;
    ...
    // repeated .bin_diff.FunctionInfo unmatched_primary = 2;
    {PROTOBUF_FIELD_OFFSET(DiffReply, _impl_.unmatched_primary_), 0, 1,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // repeated .bin_diff.FunctionInfo unmatched_secondary = 3;
    {PROTOBUF_FIELD_OFFSET(DiffReply, _impl_.unmatched_secondary_), 0, 2,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
      {::_pbi::TcParser::GetTable<::bin_diff::FunctionMatch>()},
      {::_pbi::TcParser::GetTable<::bin_diff::FunctionInfo>()},
      {::_pbi::TcParser::GetTable<::bin_diff::FunctionInfo>()},
  }},
  {{
  }},
...
::uint8_t* PROTOBUF_NONNULL DiffReply::_InternalSerialize(
  ...
  // repeated .bin_diff.FunctionInfo unmatched_primary = 2;
  for (unsigned i = 0, n = static_cast<unsigned>(
                           this_._internal_unmatched_primary_size());
       i < n; i++) {
    const auto& repfield = this_._internal_unmatched_primary().Get(i);
    target =
        ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
  ...
  // repeated .bin_diff.FunctionInfo unmatched_secondary = 3;
  for (unsigned i = 0, n = static_cast<unsigned>(
                           this_._internal_unmatched_secondary_size());
       i < n; i++) {
    const auto& repfield = this_._internal_unmatched_secondary().Get(i);
    target =
        ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
  ...
  ::_pbi::Prefetch5LinesFrom7Lines(&this_);
   {
    ...
    // repeated .bin_diff.FunctionInfo unmatched_primary = 2;
    {
      total_size += 1UL * this_._internal_unmatched_primary_size();
      for (const auto& msg : this_._internal_unmatched_primary()) {
        total_size += ::google::protobuf::internal::WireFormatLite::MessageSize(msg);
      }
    }
    // repeated .bin_diff.FunctionInfo unmatched_secondary = 3;
    {
      total_size += 1UL * this_._internal_unmatched_secondary_size();
      for (const auto& msg : this_._internal_unmatched_secondary()) {
        total_size += ::google::protobuf::internal::WireFormatLite::MessageSize(msg);
      }
    }
  }
...
void DiffReply::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  _this->_internal_mutable_unmatched_primary()->MergeFrom(
      from._internal_unmatched_primary());
  _this->_internal_mutable_unmatched_secondary()->MergeFrom(
      from._internal_unmatched_secondary());
  _this->_internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(from._internal_metadata_);
}
...
void DiffReply::InternalSwap(DiffReply* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  _impl_.unmatched_primary_.InternalSwap(&other->_impl_.unmatched_primary_);
  _impl_.unmatched_secondary_.InternalSwap(&other->_impl_.unmatched_secondary_);
}
...
class FunctionInfo::_Internal {
 public:
  using HasBits =
      decltype(std::declval<FunctionInfo>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(FunctionInfo, _impl_._has_bits_);
};

FunctionInfo::FunctionInfo(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, FunctionInfo_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:bin_diff.FunctionInfo)
}
PROTOBUF_NDEBUG_INLINE FunctionInfo::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::bin_diff::FunctionInfo& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
FunctionInfo::FunctionInfo(
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena,
    const FunctionInfo& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, FunctionInfo_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  FunctionInfo* const _this = this;
  (void)_this;
  _internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(
      from._internal_metadata_);
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ...
  // @@protoc_insertion_point(copy_constructor:bin_diff.FunctionInfo)
}
PROTOBUF_NDEBUG_INLINE FunctionInfo::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
inline void FunctionInfo::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
  new (&_impl_) Impl_(internal_visibility(), arena);
  _impl_.address_ = {};
}
FunctionInfo::~FunctionInfo() {
  // @@protoc_insertion_point(destructor:bin_diff.FunctionInfo)
  SharedDtor(*this);
}
inline void FunctionInfo::SharedDtor(MessageLite& self) {
  FunctionInfo& this_ = static_cast<FunctionInfo&>(self);
  this_._internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  ABSL_DCHECK(this_.GetArena() == nullptr);
...
inline void* PROTOBUF_NONNULL FunctionInfo::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) FunctionInfo(arena);
}
constexpr auto FunctionInfo::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(FunctionInfo),
                                            alignof(FunctionInfo));
}
constexpr auto FunctionInfo::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          &_FunctionInfo_default_instance_._instance,
          &_table_.header,
          nullptr,  // OnDemandRegisterArenaDtor
          nullptr,  // IsInitialized
          &FunctionInfo::MergeImpl,
          ::google::protobuf::Message::GetNewImpl<FunctionInfo>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &FunctionInfo::SharedDtor,
          ::google::protobuf::Message::GetClearImpl<FunctionInfo>(), &FunctionInfo::ByteSizeLong,
              &FunctionInfo::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
          PROTOBUF_FIELD_OFFSET(FunctionInfo, _impl_._cached_size_),
          false,
      },
      &FunctionInfo::kDescriptorMethods,
      &descriptor_table_bin_5fdiff_2eproto,
      nullptr,  // tracker
  };
}
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::google::protobuf::internal::ClassDataFull
        FunctionInfo_class_data_ =
            FunctionInfo::InternalGenerateClassData_();

const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL FunctionInfo::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&FunctionInfo_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(FunctionInfo_class_data_.tc_table);
  return FunctionInfo_class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 34, 2>
FunctionInfo::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(FunctionInfo, _impl_._has_bits_),
    0, // no _extensions_
    2, 8,  // max_field_number, fast_idx_mask
    offsetof(decltype(_table_), field_lookup_table),
    4294967292,  // skipmap
    ...
    0,  // num_aux_entries
    offsetof(decltype(_table_), field_names),  // no aux_entries
    FunctionInfo_class_data_.base(),
    nullptr,  // post_loop_handler
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::bin_diff::FunctionInfo>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // uint64 address = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(FunctionInfo, _impl_.address_), 1>(),
     {16, 1, 0, PROTOBUF_FIELD_OFFSET(FunctionInfo, _impl_.address_)}},
    // string name = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(FunctionInfo, _impl_.name_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string name = 1;
    {PROTOBUF_FIELD_OFFSET(FunctionInfo, _impl_.name_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // uint64 address = 2;
    {PROTOBUF_FIELD_OFFSET(FunctionInfo, _impl_.address_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
  }},
  // no aux_entries
  {{
    "\25\4\0\0\0\0\0\0"
    "bin_diff.FunctionInfo"
    "name"
  }},
};
PROTOBUF_NOINLINE void FunctionInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:bin_diff.FunctionInfo)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL FunctionInfo::_InternalSerialize(
    const ::google::protobuf::MessageLite& base, ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) {
  const FunctionInfo& this_ = static_cast<const FunctionInfo&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* PROTOBUF_NONNULL FunctionInfo::_InternalSerialize(
    ::uint8_t* PROTOBUF_NONNULL target,
    ::google::protobuf::io::EpsCopyOutputStream* PROTOBUF_NONNULL stream) const {
  const FunctionInfo& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:bin_diff.FunctionInfo)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001u) != 0) {
    if (!this_._internal_name().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "bin_diff.FunctionInfo.name");
      target = stream->WriteStringMaybeAliased(1, _s, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:bin_diff.FunctionInfo)
  return target;
}

#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t FunctionInfo::ByteSizeLong(const MessageLite& base) {
  const FunctionInfo& this_ = static_cast<const FunctionInfo&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::size_t FunctionInfo::ByteSizeLong() const {
  const FunctionInfo& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:bin_diff.FunctionInfo)
  ::size_t total_size = 0;
...
void FunctionInfo::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  auto* const _this = static_cast<FunctionInfo*>(&to_msg);
  auto& from = static_cast<const FunctionInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:bin_diff.FunctionInfo)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void FunctionInfo::CopyFrom(const FunctionInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:bin_diff.FunctionInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void FunctionInfo::InternalSwap(FunctionInfo* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using std::swap;
  auto* arena = GetArena();
  ABSL_DCHECK_EQ(arena, other->GetArena());
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::google::protobuf::Metadata FunctionInfo::GetMetadata() const {
  return ::google::protobuf::Message::GetMetadataImpl(GetClassData()->full());
}
// ===================================================================
...
constexpr auto GetReply::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(GetReply, _impl_.functions_) +
          decltype(GetReply::_impl_.functions_)::
              InternalGetArenaOffset(
                  ::google::protobuf::Message::internal_visibility()),
  });
  if (arena_bits.has_value()) {
...
GetReply::_table_ = {
  {
    ...
    // repeated .bin_diff.FunctionInfo functions = 1;
    {::_pbi::TcParser::FastMtR1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(GetReply, _impl_.functions_)}},
  }}, {{
    65535, 65535
  }}, {{
    // repeated .bin_diff.FunctionInfo functions = 1;
    {PROTOBUF_FIELD_OFFSET(GetReply, _impl_.functions_), 0, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
      {::_pbi::TcParser::GetTable<::bin_diff::FunctionInfo>()},
